...
<p> Providing workplace that is pleasant and comfortable to our employees. Commitment in pursuit of higher goals.
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <div id="team_div">
                    <img class="img-responsive" src="<?=base_url('images')?>/face1.jpg" alt="">
                    </div>
                    <div class="caption">
                        <h3>John Smith<br>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <div id="team_div">
                    <img class="img-responsive" src="<?=base_url('images')?>/face_meagan.jpg" alt="">
                    </div>
                    <div class="caption">
                        <h3>John Smith<br>
                            <small>Job Title</small>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <div id="team_div">
                    <img class="img-responsive" src="<?=base_url('images')?>/face_tom.jpg" alt="">
                    </div>
                    <div class="caption">
                        <h3>John Smith<br>
                            <small>Job Title</small>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <div id="team_div">
                    <img class="img-responsive" src="<?=base_url('images')?>/face_brad.jpg" alt="">
                    </div>
                    <div class="caption">
                        <h3>John Smith<br>
                            <small>Job Title</small>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <div id="team_div">
                    <img class="img-responsive" src="<?=base_url('images')?>/face_kate.jpg" alt="">
                    </div>
                    <div class="caption">
                        <h3>John Smith<br>
                            <small>Job Title</small>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <div id="team_div">
                    <img class="img-responsive" src="<?=base_url('images')?>/face_matt.jpg" alt="">
                    </div>
                    <div class="caption">
                        <h3>John Smith<br>
                            <small>Job Title</small>
        ...
        <div class="col-md-4 col-sm-6">
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_yacht_club.jpg">
             </div>
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_ace.png">
             </div>

              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_brady.gif">
             </div>
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_sti.JPG">
             </div>
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_sti_santos.jpeg">
             </div>
            </div>

    <div class="col-md-4 col-sm-6">
             <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_sti_medical.jpg">
             </div>
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_sti_medical_clinic.jpg">
             </div>

              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_pacific.jpeg">
             </div>
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_sm_masinag.jpg">
             </div>
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_md.jpg">
             </div>
            ...
            <div class="col-md-4 col-sm-6">
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_sm_pasig.jpg">
             </div>
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_vista.jpg">
             </div>

              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_sm_taytay.jpg">
             </div>
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_best_mobile.jpg">
             </div>
              <div id="logo_div">
                 <img src="<?=base_url('images')?>/logo_canadian.png">
             </div>
